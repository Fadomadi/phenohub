...
const ImpressumPage = () => {
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-50 via-white to-green-100 px-4 py-12 theme-dark:bg-gradient-to-b theme-dark:from-slate-950 theme-dark:via-slate-950 theme-dark:to-slate-900">
      <div className="mx-auto max-w-3xl space-y-10 rounded-3xl border border-green-100 bg-white/95 p-8 shadow-xl shadow-green-100/50 backdrop-blur-sm theme-dark:border-slate-800 theme-dark:bg-slate-900/80 theme-dark:shadow-slate-900/40">
        <header className="space-y-4">
          ...
          <h1 className="text-3xl font-semibold text-gray-900 theme-dark:text-slate-100">Impressum</h1>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-900 theme-dark:text-slate-100">Betreiber</h2>
          <address className="space-y-1 text-sm not-italic leading-relaxed text-gray-700 theme-dark:text-slate-300">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 theme-dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 theme-dark:text-slate-100">Verantwortlich für den Inhalt</h2>
          <p>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 theme-dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 theme-dark:text-slate-100">Haftungshinweise</h2>
          <p>
