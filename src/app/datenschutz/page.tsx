    ...
    <main className="min-h-screen bg-gradient-to-b from-green-50 via-white to-green-100 px-4 py-12 dark:bg-gradient-to-b dark:from-slate-950 dark:via-slate-950 dark:to-slate-900">
      <div className="mx-auto max-w-3xl space-y-10 rounded-3xl border border-green-100 bg-white/95 p-8 shadow-xl shadow-green-100/40 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-900/80 dark:shadow-slate-900/40">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">1. Verantwortlicher</h2>
          <p>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">2. Verarbeitete Daten</h2>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">3. Zwecke & Rechtsgrundlagen</h2>
          <p>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">4. Empfänger der Daten</h2>
          <p>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">6. Deine Rechte</h2>
          <p>
        ...
        <section className="space-y-3 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">7. Cookies & Tracking</h2>
          <p>
